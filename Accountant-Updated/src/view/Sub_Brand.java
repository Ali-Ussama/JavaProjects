...
import controller.SubBrandAction;
...
public class Sub_Brand {
	...
	private SubBrandAction mSubBrandAction;
	
 	public void StartSubBrand() {
			Initialize();
			AddComponent();
			Padding();
			...
			stage.show();
			AddBtn.setOnAction(e->mSubBrandAction.onAddMajorBrandListener(TFName));
			UpdateBtn.setOnAction(e->mSubBrandAction.onUpdateMajorBrandListener(TFID, TFName));
			DeleteBtn.setOnAction(e->mSubBrandAction.onDeleteMajorBrandListener(TFID));
	}
	...
	private void Initialize() {
		...
		//Action
		mSubBrandAction = new SubBrandAction();
		//Create Table View.
        TableView();
	...
	private void TableView() {
		try {
			...
			// initialize the columns in the table.   
		        ...
		        mSubBrandAction.TableRefresh(table);
